...
var connectionString = builder.Configuration.GetConnectionString("DefaultConnection") 
    ?? "Host=localhost;Database=labtrack;Username=postgres;Password=postgres";
...
// UPDATED: CORS with production URLs
...
// UPDATED: Use the new CORS policy name
...
using (var scope = app.Services.CreateScope())
{
    ...
    {
        // If migrations don't exist, fall back to EnsureCreated
